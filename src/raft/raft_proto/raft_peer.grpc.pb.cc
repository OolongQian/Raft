...
::grpc::ClientAsyncResponseReader< ::PbAppendEntriesResponse>* RaftPeerService::Stub::AsyncAppendEntriesRPCRaw(::grpc::ClientContext* context, const ::PbAppendEntriesRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::PbAppendEntriesResponse>::Create(channel_.get(), cq, rpcmethod_AppendEntriesRPC_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::PbAppendEntriesResponse>* RaftPeerService::Stub::PrepareAsyncAppendEntriesRPCRaw(::grpc::ClientContext* context, const ::PbAppendEntriesRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::PbAppendEntriesResponse>::Create(channel_.get(), cq, rpcmethod_AppendEntriesRPC_, context, request, false);
}

::grpc::Status RaftPeerService::Stub::RequestVoteRPC(::grpc::ClientContext* context, const ::PbRequestVoteRequest& request, ::PbRequestVoteResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_RequestVoteRPC_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::PbRequestVoteResponse>* RaftPeerService::Stub::AsyncRequestVoteRPCRaw(::grpc::ClientContext* context, const ::PbRequestVoteRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::PbRequestVoteResponse>::Create(channel_.get(), cq, rpcmethod_RequestVoteRPC_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::PbRequestVoteResponse>* RaftPeerService::Stub::PrepareAsyncRequestVoteRPCRaw(::grpc::ClientContext* context, const ::PbRequestVoteRequest& request, ::grpc::CompletionQueue* cq) {
...
::grpc::Status RaftPeerService::Service::AppendEntriesRPC(::grpc::ServerContext* context, const ::PbAppendEntriesRequest* request, ::PbAppendEntriesResponse* response) {
  (void) context;
  (void) request;
  (void) response;
...
::grpc::Status RaftPeerService::Service::RequestVoteRPC(::grpc::ServerContext* context, const ::PbRequestVoteRequest* request, ::PbRequestVoteResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
