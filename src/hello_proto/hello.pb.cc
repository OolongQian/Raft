...
namespace protobuf_hello_2eproto {
	...
	const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
			...
			GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::HelloRequest, greeting_),
			~0u,  // no _has_bits_
			GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::HelloResponse, _internal_metadata_),
			~0u,  // no _extensions_
			~0u,  // no _oneof_case_
			~0u,  // no _weak_field_map_
			GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::HelloResponse, reply_),
	};
	...
	void protobuf_AssignDescriptors() {
		AddDescriptors();
		AssignDescriptors(
				"hello0.proto", schemas, file_default_instances, TableStruct::offsets,
	...
	void AddDescriptorsImpl() {
		...
		::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
				"hello0.proto", &protobuf_RegisterTypes);
	}
...
namespace google {
	namespace protobuf {
		template<>
		GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::HelloRequest *Arena::CreateMaybeMessage<::HelloRequest>(Arena *arena) {
			return Arena::CreateInternal<::HelloRequest>(arena);
		}

		template<>
		GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::HelloResponse *Arena::CreateMaybeMessage<::HelloResponse>(Arena *arena) {
