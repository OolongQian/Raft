...
src/hello: src/libraft_proj.a
src/hello: /usr/local/lib/libboost_thread-mt.dylib
src/hello: /usr/local/lib/libboost_log-mt.dylib
src/hello: /usr/local/lib/libboost_unit_test_framework-mt.dylib
src/hello: /usr/local/lib/libboost_serialization-mt.dylib
src/hello: /usr/local/lib/libboost_chrono-mt.dylib
src/hello: /usr/local/lib/libboost_system-mt.dylib
src/hello: /usr/local/lib/libboost_date_time-mt.dylib
src/hello: /usr/local/lib/libboost_atomic-mt.dylib
src/hello: /usr/local/lib/libboost_log_setup-mt.dylib
src/hello: /usr/local/lib/libboost_filesystem-mt.dylib
src/hello: /usr/local/lib/libboost_regex-mt.dylib
src/hello: /usr/local/lib/libprotobuf.dylib
src/hello: /usr/local/lib/libgrpc++.dylib
src/hello: /usr/local/lib/libgrpc.dylib
src/hello: /usr/local/lib/libgpr.dylib
src/hello: src/CMakeFiles/hello.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir="/Users/qiansucheng/Desktop/ACM班/2018夏/ppca/distributed system/raft_proj/cmake-build-debug/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable hello"
